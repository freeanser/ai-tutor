  ...
  return (
    <main className="min-h-screen bg-white p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <textarea
          className="w-full h-64 p-4 border-2 border-slate-200 rounded-lg focus:border-blue-500 outline-none text-black"
          value={essay}
        ...
        {feedback && (
          <div className="mt-8 p-6 bg-slate-50 border border-slate-200 rounded-lg">
            <h2 className="font-bold mb-2 text-slate-700">批改結果：</h2>
